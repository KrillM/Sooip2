...
class MemberControllerTest {
    ...
    public Member createMember(String email, String password){
        ...
        memberFormDto.setName("명길식");
        memberFormDto.setAddress("서울특별시 마포구 양화로 45");
        memberFormDto.setAddressDetail("101동 1004호");
        memberFormDto.setAddressInfo("서교동 메세나폴리스");
        memberFormDto.setPostNumber("04036");
